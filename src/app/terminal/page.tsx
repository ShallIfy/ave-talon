    ...
    >
      ...
      <div className="flex items-center gap-3 border-t border-white/[0.04] px-4 py-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          >
            {meta.telegramSent ? (
              <a href="https://t.me/Ave_Talon" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300/80 transition-colors">
                Sent to @Ave_Talon
              </a>
            ) : "Not sent"}
          </span>
    ...
    <main className="mx-auto flex h-[calc(100dvh-48px)] w-full max-w-[1200px] flex-col px-4 py-5 sm:px-6 lg:h-dvh">
      ...
      <div className="mb-5 flex items-end justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            href="https://t.me/Ave_Talon"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 font-mono text-[8px] uppercase tracking-[0.1em] text-blue-400/50 transition-colors hover:text-blue-400/80"
          >
